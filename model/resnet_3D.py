...
class VideoResNet(nn.Module):
    ...
    def __init__(self, in_channels, block, conv_makers, layers,
...
def unet_18(pretrained=False, bn=False, progress=True, in_channels=3, **kwargs):
    """
    ...
    return _video_resnet('r3d_18',
                         pretrained, progress,
                         block=BasicBlock,in_channels=in_channels,
